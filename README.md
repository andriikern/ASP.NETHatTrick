...
The app was meant to be implemented from a [DBMS](http://en.wikipedia.org/wiki/Database#Database_management_system)-agnostic point of view, and to simulate scalable real-world apps where possible, therefore issues like [this one](http://learn.microsoft.com/en-gb/dotnet/standard/data/sqlite/async/) were ignored. Instead, [asynchronous methods](http://learn.microsoft.com/en-gb/dotnet/csharp/asynchronous-programming/async-scenarios/) were preferred as advised [here](http://learn.microsoft.com/en-gb/aspnet/core/fundamentals/best-practices/#avoid-blocking-calls), even though [SQLite](http://sqlite.org/) is used by default.
